...
import 'package:dropdown_search_plus/dropdown_search_plus.dart';
import 'package:flutter/foundation.dart';
import 'package:flutter/material.dart';

export 'properties/bottom_sheet_props.dart';
export 'properties/clear_button_props.dart';
export 'properties/dialog_props.dart';
export 'properties/dropdown_button_props.dart';
export 'properties/dropdown_decorator_props.dart';
export 'properties/favorite_item_props.dart';
export 'properties/icon_button_props.dart';
export 'properties/list_view_props.dart';
export 'properties/menu_props.dart';
export 'properties/modal_bottom_sheet_props.dart';
export 'properties/popup_props.dart';
export 'properties/scrollbar_props.dart';
export 'properties/text_field_props.dart';
...
class DropdownSearchPlus<T> extends StatefulWidget {
  ///offline items list
  final List<T> items;
  ...
  DropdownSearchPlus.multiSelection({
    Key? key,
    this.autoValidateMode = AutovalidateMode.disabled,
    this.items = const [],
    this.asyncItems,
  ...
  @override
  DropdownSearchPlusState<T> createState() => DropdownSearchPlusState<T>();
}

class DropdownSearchPlusState<T> extends State<DropdownSearchPlus<T>> {
  ...
  @override
  void didUpdateWidget(DropdownSearchPlus<T> oldWidget) {
